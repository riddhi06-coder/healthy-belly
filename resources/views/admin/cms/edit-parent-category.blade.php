		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
                    ...
                    <form data-toggle="validator" action="{{route('admin.update_parent_category')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="product_category_name" name="product_category_name" value="{{$cat_detail->category_name}}" placeholder="Product Category Name" >
