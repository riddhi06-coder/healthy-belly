		...
		<div class="row small-spacing">
			<div class="col-xs-12">
				<div class="box-content">
                    ...
                    <form data-toggle="validator" action="{{route('admin.update_advertisement')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <textarea type="text" class="form-control ckeditor" id="title" name="title" placeholder="Advertisement Title" >{{$ads_detail->title}}</textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <td><label for="inputName" class="control-label">Link</label>
                                    <input type="text" class="form-control" id="link" name="link" value="{{$ads_detail->link}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    <img src="{{asset('public/frontend/images/advertisement')}}/{{$ads_detail->image}}" >
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="old_image" value="{{$ads_detail->image}}" >
						<div class="form-group">
