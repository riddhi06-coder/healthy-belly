				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
					  ...
					  <div class="bs-stepper-content">
						<form action="{{route('vision_mission_motto.insert_vision_mission_motto')}}" method="post" enctype="multipart/form-data">
							@csrf
						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
							...
							<div class="row g-3">
								...
								<div class="col-12 col-lg-6">
									...
									<textarea type="text" class="form-control" name="first_description"></textarea>
								...
								<div class="col-12 col-lg-6">
									...
									<textarea type="text" class="form-control" name="second_description"></textarea>
								...
								<div class="col-12 col-lg-6">
									...
									<textarea type="text" class="form-control" name="third_description"></textarea>
