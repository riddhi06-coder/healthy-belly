					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Accreditation Awards List</li>
								<li class="breadcrumb-item"><a href="{{route('accreditation_awards.add_accreditation_awards')}}"><i class="lni lni-circle-plus"></i>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Add Accreditation Awards</li></a>
							</ol>
						</nav>
					</div>
				</div>
							...
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td><img height="100" width="200" src="{{asset('public/awards/'.$value->image)}}"></td>
										<td>
