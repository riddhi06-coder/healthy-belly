		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Newsletter</div>
					<div class="ps-3">
				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
					  ...
					  <div class="bs-stepper-content">
						<form action="{{route('services.update_newsletter')}}" method="post" enctype="multipart/form-data">
							@csrf
                            <input type="hidden" name="id" value="{{$data->id}}" class="form-control" placeholder="id">

						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
							<h5 class="mb-1">Edit Newsletter</h5><br>
							...
							<div class="row g-3">
								...
								<div class="col-12 col-lg-6">
									<label for="Sub-Title" name="Sub-Title" class="form-label">PDF</label>
								...
								<div class="col-12 col-lg-6">
									<a href="{{ asset('public/services/newsletter/'.$data->pdf)}}" height="200" withidth="200">View existing PDF</a>
									@error('pdf')
									<span style="color: red" role="alert">
									<strong>{{ $message }}</strong>
									</span>
