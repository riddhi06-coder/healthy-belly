				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
					  ...
					  <div class="bs-stepper-content">
						<form action="{{route('services.update_services')}}" method="post" enctype="multipart/form-data">
							@csrf
                            <input type="hidden" name="id" value="{{$data->id}}" class="form-control">							

						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
							<h5 class="mb-1">Edit Services</h5><br>
							...
							<div class="row g-3">
								...
								<div class="col-12 col-lg-6">
									<label for="Image" name="Image" class="form-label">Image</label>
                                    <img src="{{asset('public/services/'.$data->image)}}" height="200" width="200">				
                                    @error('image')
									<span style="color: red" role="alert">
									<strong>{{ $message }}</strong>
									</span>
