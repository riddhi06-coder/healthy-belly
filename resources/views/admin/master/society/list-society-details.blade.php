...
<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Society Details</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">List Society Details</li></a>
							</ol>
						</nav>
					</div>
				</div>
							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th>Institutions Title</th>
										<th>Institutions Description</th>
										<th>Action</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										<td>{{$value->objectives_title}}</td>
										<td>{{$value->objectives_description}}</td>
										<td>{{$value->institutions_description}}</td>
                                        @if($value->status == 1)
                                        <td>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{route('society.edit_society_details')}}/{{$value->id}}" class="btn btn-info">edit</a>
