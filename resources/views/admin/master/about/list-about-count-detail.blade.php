...
<div class="page-wrapper">
			...
			<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
				<div class="breadcrumb-title pe-3"> About Count Details</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page"> About Count Details List</li>
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('about.delete_about_count_detail')}}/{{$value->id}}" class="btn btn-danger">delete</a>
                                    </td>
									</tr>
                                    @endforeach
                                </tbody>
