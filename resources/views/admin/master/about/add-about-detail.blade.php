		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Add About Details</div>
					<div class="ps-3">
				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
					  ...
					  <div class="bs-stepper-content">
						<form action="{{route('about.insert_about_detail')}}" method="post" enctype="multipart/form-data">
							@csrf
						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="col-12 col-lg-6">
									...
									<input type="text" class="form-control" name="year_count" id="year_count" placeholder="Year Count">
									@error('year_count')
									<span style="color: red" role="alert">
									<strong>{{ $message }}</strong>
									</span>
