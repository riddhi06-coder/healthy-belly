				  ...
				  <div class="card">
				    ...
				    <div class="card-body">
					  ...
					  <div class="bs-stepper-content">
						<form action="{{route('testimonial.update_testimonial')}}" method="post" enctype="multipart/form-data">
							@csrf
                            <input type="hidden" id="id" class="form-control" value="{{$data->id}}" name="id">

						  <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1">
							<h5 class="mb-1">Edit Testimonial</h5><br>
							...
							<div class="row g-3">
								...
								<div class="col-12 col-lg-6">
									<label for="Sub-Title" name="Sub-Title" class="form-label">Designation</label>
								...
								<div class="col-12 col-lg-6">
								<label for="Image" name="Image" class="form-label">Image</label>
								<img height="100" width="200" src="{{asset('public/testimonial/'.$data->image)}}">
								</div>
